...
Create a lightweight SDK, middleware, or wrapper around your LLM calls that captures inference metadata. (Note that if you can create an architecture which can AUTO-INTRUMENT)
